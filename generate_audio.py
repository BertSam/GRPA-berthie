...
modifié par Berthie Gouin-Ferland (20-07-13)
"""
import os
...
#    model = SampleRNN([16, 4], 2, 1024, True, 256, True)
    ...
    generator = GeneratorPlugin(params['generate_to'], params['n_samples'], params['sample_length'], params['sample_rate'], params['M'])
